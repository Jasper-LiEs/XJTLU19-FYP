...
labels_2 = to_categorical(result_2.iloc[:-window_size]['label'])
...
model1 = Sequential()
model1.add(LSTM(128, input_shape=(window_size, 2)))
model1.add(Dense(3, activation='softmax'))
model1.compile(loss='categorical_crossentropy', optimizer='adam', metrics=['accuracy'])

model2 = Sequential()
model2.add(LSTM(128, input_shape=(window_size, 2)))
model2.add(Dense(2, activation='softmax'))
model2.compile(loss='categorical_crossentropy', optimizer='adam', metrics=['accuracy'])

model3 = Sequential()
model3.add(LSTM(128, input_shape=(window_size, 2)))
model3.add(Dense(3, activation='softmax'))
model3.compile(loss='categorical_crossentropy', optimizer='adam', metrics=['accuracy'])


# model1.fit(data_1[:,:,:2], labels_1, epochs=20, batch_size=32)
# loss, acc = model1.evaluate(data_4[:,:,:2], ans, batch_size=32)
# print('Test accuracy for model 1:', acc)

model2.fit(data_2[:,:,:2], labels_2, epochs=20, batch_size=32)
loss, acc = model2.evaluate(data_4[:,:,:2], ans, batch_size=32)
print('Test accuracy for model 2:', acc)

# model3.fit(data_3[:,:,:2], labels_3, epochs=20, batch_size=32)
# loss, acc = model3.evaluate(data_4[:,:,:2], ans, batch_size=32)
# print('Test accuracy for model 3:', acc)