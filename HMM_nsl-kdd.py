...
train_data = result['state'][:train_size]
test_data = result['state'][train_size:]
ans_data = result['label'][train_size:]

model = CategoricalHMM(n_components=n_states, n_iter=50, tol=0.0001, verbose=False, params='te',init_params='te')
...
# #保存模型
# output = open(r'C:\Users\zhichen.liang19\Desktop\ruxue_hmm_0.pkl', 'wb')
